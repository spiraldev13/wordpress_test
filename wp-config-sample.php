...
define('DB_NAME', 'database_name_here'); // db_name => oagency

/** MySQL database username */
define('DB_USER', 'username_here'); // username => oagency

/** MySQL database password */
define('DB_PASSWORD', 'password_here'); // pass => oagency
...
// Bloque l'éditeur embarqué CSS dans back Office de WordPress
